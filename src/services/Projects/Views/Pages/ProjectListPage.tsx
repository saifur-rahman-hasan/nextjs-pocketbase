...
import {useCreateNewProjectMutation, useGetProjectsQuery} from "@/services/Projects/Store/ProjectApiSlice";
...
export default function ProjectListPage() {
	...
	return (
		<>
			...
			{ projectDataIsLoading && <div>Loading ...</div> }
			{ !projectDataIsLoading && projectDataIsSuccess && !projectData?.length && (<div>You have no data</div>) }
			{ !projectDataIsLoading && projectDataIsSuccess && projectData?.length > 0 && <ProjectLists projects={projectData} /> }
...
function ProjectViewLink({project}: {project: any}) {
	return (
		<a
			href={project.href}
...
function ProjectLists({ projects }: {projects: any[]}) {
	return (
