...
export function DashboardSidebar({ sidebarOpen, setSidebarOpen }: SidebarProps) {
	return (
		<>
...
export function StaticSidebarForDesktop() {
	return (
...
export function SidebarForMobile({ sidebarOpen, setSidebarOpen }: SidebarProps) {
	return (
